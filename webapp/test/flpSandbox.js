		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fruits Fiori App to check WebIDE Features",
									"targetURL": "#FruitsFioriApptocheckWebIDEFeatures-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FruitsFioriApptocheckWebIDEFeatures-display": {
								"semanticObject": "FruitsFioriApptocheckWebIDEFeatures",
								"action": "display",
								"description": "My Fruits fiori app for checking WebIDE",
								"title": "Fruits Fiori App to check WebIDE Features",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oft.demo.FruitsApp",
									"url": sap.ui.require.toUrl("oft/demo/FruitsApp")
								}
							}
						}
					}
